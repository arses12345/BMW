...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f2027,50:203a43,100:2c5364&height=220&section=header&text=arses%20Gateway&fontSize=60&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=Multi-Protocol%20Proxy%20Management%20Panel&descAlignY=58&descSize=18" width="100%"/>
...
![Stars](https://img.shields.io/github/stars/arvin341az-glitch/arses?style=social)
![Forks](https://img.shields.io/github/forks/arvin341az-glitch/arses?style=social)
![Last Commit](https://img.shields.io/github/last-commit/arvin341az-glitch/arses?color=2c5364)
![Repo Size](https://img.shields.io/github/repo-size/arvin341az-glitch/arses?color=0f2027)
...
**arses Gateway** is a fast, modern, self-hosted **multi-protocol proxy management panel**, built with **Python + FastAPI**, designed to deploy in minutes on **Railway**.
...
> 💡 Originally built around a simple VLESS-over-WebSocket relay, arses has evolved into a full multi-protocol gateway with authentication, quota tracking, and a polished management UI.
...
```mermaid
flowchart LR
    A[Client / v2rayNG / NekoBox] -->|VLESS / Trojan / SS| B(arses Gateway<br/>FastAPI Server)
    B --> C{Protocol Router}
...
```bash
# Clone your fork
git clone https://github.com/<your-username>/arses.git
cd arses
...
**arses Gateway** یک پنل مدیریت پروکسی چندپروتکلی، سریع و مدرن است که با **Python + FastAPI** ساخته شده و در چند دقیقه روی **Railway** قابل دیپلوی است.
...
```mermaid
flowchart RL
    A[کلاینت / v2rayNG / NekoBox] -->|VLESS / Trojan / SS| B(arses Gateway<br/>سرور FastAPI)
    B --> C{مسیریاب پروتکل}
